# =============================================================================
# SIMA Platform - PROD Environment
# Completely isolated from QA (different VPC CIDR)
# =============================================================================
...
# PROD VPC uses 10.1.0.0/16 (QA uses 10.0.0.0/16 - NO OVERLAP)
variable "vpc_cidr" {
  default = "10.1.0.0/16"
}
...
variable "instance_type" {
  default = "t2.small" # Slightly larger for prod
}
...
module "ec2_asg" {
  ...
  # PROD: Downloads Docker images from registry
  user_data = templatefile("${path.module}/../../scripts/bootstrap-prod.sh.tpl", {
